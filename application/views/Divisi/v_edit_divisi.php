<div class="midde_cont">
    <div class="container-fluid">
        ...
        <div id="layoutSidenav_content">
            <main>
                <form action="<?php echo base_url('Divisi/editDivisi_proses/'.$divisi['id_divisi']); ?>" method="post" role="form">

				<input type="hidden" name="id_divisi" value="<?= $divisi['id_divisi'] ?>">
                
                <div class="form-group">
                    <label for="formGroupExampleInput2">Divisi</label>
                    <input type="text" class="form-control col-md-6" name="divisi" id="formGroupExampleInput2" placeholder="" value=<?= $divisi['divisi'] ?>>
                </div>
				...
				<div class="form-group">
                    ...
                    <select class="form-control col-md-6" name="id_perusahaan" require="true">
						...
						<?php foreach($perusahaan as $p) : ?>
							<option value="<?= $p->id_perusahaan ?>" <?php if ($divisi['id_perusahaan'] == "$p->id_perusahaan") echo "selected"; ?>><?= $p->perusahaan ?></option>
						<?php endforeach ?>
                    </select>
                </div>
